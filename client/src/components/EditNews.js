...
function EditNews(props) {
  ...
  return (
    <form onSubmit={ handleSubmit((value)=> props.updateNews({
        ...value,
        id: props.data.id,
    ...
    >
      ...
      <div className="data__content">
        ...
        <div key={`${props.data.id}-input`} className="paragraph data__item" >
      ...
      <div className="data__button-bar">
        ...
        <button className="data__btn" type="button" onMouseDown={() => props.deleteNews(props.data.id)}>Удалить</button>
      </div>
    </form>
  );
}

export default connect(null, { updateNews, deleteNews })(EditNews);